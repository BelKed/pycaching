...
class TestProperties(unittest.TestCase):
    ...
    def test_original_location(self):
        ...
        with self.subTest("automatic str conversion"):
            ...
            self.assertEqual(self.c.original_location, Point.from_string("S 36 51.918 E 174 46.725"))
...
class TestMethods(LoggedInTest):
    ...
    def test_load_logbook(self):
        with self.recorder.use_cassette("cache_logbook"):
            ...
            logs = [(log.uuid, log.author, log.type) for log in self.c.load_logbook(limit=200)]
